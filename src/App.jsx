...
import PlaybackControls from './components/PlaybackControls'; // <-- Import new component
import './App.css';
...
function App() {
  ...
  // --- YOUTUBE PLAYER EVENT HANDLERS (UPDATED) ---
  ...
  const onPlayerStateChange = (event) => {
    ...
    if (event.data === 1) {
      setIsPlaying(true);
      setDuration(playerRef.current.getDuration()); // Update duration in case it was not ready before
  ...
  // Main search and select functions (no changes here)
  ...
  return (
    <div className="App">
      ...
      <main>
        ...
        {/* The hidden player and visible controls */}
        {selectedVideo && (
          <>
